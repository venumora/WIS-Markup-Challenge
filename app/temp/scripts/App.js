...
$(document).ready(function () {
    var pictureCallback = function pictureCallback(event) {
        var picture = document.getElementById("largeImageContainer");
    ...
    $(".preview__small__items__item a").click(pictureCallback).keydown(function (event) {
        if (event.which === 13) {
            pictureCallback(event);
        }
    });

    var expandCallback = function expandCallback(event) {
        var targetBody = $(event.currentTarget).parent('.accordian__head').next('.accordian__body');
    ...
    $(".accordian__head__link").keydown(function (event) {
        if (event.which === 13) {
    ...
    var modalCloseCallback = function modalCloseCallback(event) {
        $("#addToCartModal").hide();
        event.preventDefault();
    };

    $("#closeModal").click(modalCloseCallback).keydown(function (event) {
        if (event.which === 13) {
